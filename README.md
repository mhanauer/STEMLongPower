...
# If we are assuming that white women have a score of 6.5 and we are expecting that by
# Actually this should be 6.5, because that intercept is the value when 
b00Val <-6.5
...
t_values <- replicate(100, STEMLong())
repNum = 100
