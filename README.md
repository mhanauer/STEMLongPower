...
PowerN150 = cbind(Power150$time_hisp, repNum)
...
PowerN160 = cbind(Power160$time_hisp, repNum)
...
PowerN170 = cbind(Power170$time_hisp, repNum)
...
PowerN180 = cbind(Power180$time_hisp, repNum)
...
PowerN190 = cbind(Power190$time_hisp, repNum)
...
PowerN200 = cbind(Power200$time_hisp, repNum)
colnames(PowerH200) = c("Power", "N")

#######Power Table#############################################
# Just rbind everything and plot it 
PowerTable = rbind(PowerN150, PowerN160, PowerN170, PowerN180, PowerN190, PowerN200)
